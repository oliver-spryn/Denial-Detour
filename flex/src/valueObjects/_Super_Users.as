...
public class _Super_Users extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
	...
	private var _internal_first : String;
	private var _internal_last : String;
    ...
    {    	
        var recalcValid:Boolean = false;
    	if (value == null || _internal_first == null)
    	{
    		recalcValid = true;
    	}	
    	
    	
    	var oldValue:String = _internal_first;               
        if (oldValue !== value)
        {
    ...
    {    	
        var recalcValid:Boolean = false;
    	if (value == null || _internal_last == null)
    	{
    		recalcValid = true;
    	}	
    	
    	
    	var oldValue:String = _internal_last;               
        if (oldValue !== value)
        {
   ...
   model_internal function setterListenerAnyConstraint(value:flash.events.Event):void
   {
    ...
    model_internal function calculateIsValid():Boolean
    {
		...
		if (_model.isFirstAvailable && _internal_first == null)
		{
			violatedConsts.push("firstIsRequired");
			validationFailureMessages.push("first is required");
		}
		if (_model.isLastAvailable && _internal_last == null)
		{
			violatedConsts.push("lastIsRequired");
			validationFailureMessages.push("last is required");
		}
